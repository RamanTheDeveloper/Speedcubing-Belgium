      ...
      <div className="max-w-5xl mx-auto flex justify-center">
        <div className="bg-white border border-gray-100 rounded-2xl px-8 py-10 max-w-2xl">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-4 leading-snug">
            Promoting Speedcubing in Belgium
          </h2>
          <p className="text-gray-500 text-sm leading-relaxed">
            To promote and develop speedcubing in Belgium by organizing
            high-quality competitions, fostering a vibrant community, and
            supporting cubers of all levels in their pursuit of excellence.
          </p>
        </div>
      </div>
    </section>
